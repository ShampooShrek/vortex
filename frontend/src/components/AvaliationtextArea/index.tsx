...
interface AvaliationTextAreaProsp {
  text: string
  type: "LIKE" | "DISLIKE"
  gameTime: number
  avaliationGameTime: number
  day: string
  qtdeLike: number
  qtdeDeslike: number
}

const AvaliationTextArea = ({
  avaliationGameTime, day, gameTime, qtdeDeslike, qtdeLike, text, type }
  : AvaliationTextAreaProsp) => {
...
export default AvaliationTextArea
