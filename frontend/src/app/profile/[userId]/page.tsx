...
//   if (token) {
//     const idRequest = await ApiRequests.GetIdByToken(token.value)
//     const socialRequest = await ApiRequests.SocialRequest(token.value)
//     if (typeof idRequest !== "string") user = idRequest
//     if (typeof socialRequest !== "string") social = socialRequest
//   }

//   const profileFetch: Promise<Response<Profile | string>> = fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/users/${userId}`, {
//     cache: "no-store",
//     headers: {
...
//   if (typeof profile.response === "string") {
//     let requests = 0
//     while (typeof profile.response === "string" && requests < 5) {
//       requests++
//       profile = await profileFetch
//     }
//     if (requests >= 5 && typeof profile.response === "string") {
//       redirect("/home")
//     }
//   }

//   const { games, groups: userGroups, friends, favorites, wishList, gamesAvaliations, userAchievements, adminGroups, privacity, id }
//     = profile.response as Profile
...
//       <S.Container>
//         <UserHeader userRequest={profile.response as Profile} social={social} user={user} userId={userId} />
//         <Line />
//         <S.Content>
